...
contract Minter is Manager, IMinter {
    ...
    uint256 public override currentMintableTokens;
    // Current number of minted tokens. Reset every round
    uint256 public override currentMintedTokens;
     ...
     */
    function trustedTransferTokens(address _to, uint256 _amount) external override onlyBondingManager whenSystemNotPaused {
     ...
     */
    function trustedBurnTokens(uint256 _amount) external override onlyBondingManager whenSystemNotPaused {
     ...
     */
    function depositETH() external override payable onlyMinterOrJobsManager returns (bool) {
        return true;
    }
     ...
     */
    function setCurrentRewardTokens() external override onlyRoundsManager whenSystemNotPaused {
        setInflation();
